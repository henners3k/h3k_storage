...
import com.github.henners3k.h3k_storage.mod.H3KStorageStrings;
...
public enum H3KChestType {
    ...
    IRON(6, 9, new ResourceLocation(H3KStorageStrings.MOD_ID, "textures/gui/container/chest/iron_chest.png"), 176, 222, 256, 256, H3KStorageTiles.IRON_CHEST, H3KStorageContainers.IRON_CHEST),
    GOLD(9, 9, new ResourceLocation(H3KStorageStrings.MOD_ID, "textures/gui/container/chest/gold_chest.png"), 176, 275, 512, 512, H3KStorageTiles.GOLD_CHEST, H3KStorageContainers.GOLD_CHEST),
    DIAMOND(6, 18, new ResourceLocation(H3KStorageStrings.MOD_ID, "textures/gui/container/chest/diamond_chest.png"), 338, 222, 512, 512, H3KStorageTiles.DIAMOND_CHEST, H3KStorageContainers.DIAMOND_CHEST),
    NETHERITE(9, 18, new ResourceLocation(H3KStorageStrings.MOD_ID, "textures/gui/container/chest/netherite_chest.png"), 338, 276, 512, 512, H3KStorageTiles.NETHERITE_CHEST, H3KStorageContainers.NETHERITE_CHEST);
