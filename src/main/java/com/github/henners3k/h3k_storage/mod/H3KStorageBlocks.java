...
public final class H3KStorageBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, H3KStorageStrings.MOD_ID);

    // Chests
    public static final RegistryObject<Block> IRON_CHEST = BLOCKS.register(H3KStorageStrings.IRON_CHEST,
    ...
    public static final RegistryObject<Block> GOLD_CHEST = BLOCKS.register(H3KStorageStrings.GOLD_CHEST,
    ...
    public static final RegistryObject<Block> DIAMOND_CHEST = BLOCKS.register(H3KStorageStrings.DIAMOND_CHEST,
    ...
    public static final RegistryObject<Block> NETHERITE_CHEST = BLOCKS.register(H3KStorageStrings.NETHERITE_CHEST,
