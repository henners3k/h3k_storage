...
public final class H3KStorageTiles {
    ...
    public static final RegistryObject<TileEntityType<H3KChestTile>> GOLD_CHEST = TILES.register(Constants.GOLD_CHEST,
            () -> TileEntityType.Builder.create(H3KChestType.GOLD::createTile, H3KStorageBlocks.GOLD_CHEST.get()).build(null)
    );
    public static final RegistryObject<TileEntityType<H3KChestTile>> DIAMOND_CHEST = TILES.register(Constants.DIAMOND_CHEST,
            () -> TileEntityType.Builder.create(H3KChestType.DIAMOND::createTile, H3KStorageBlocks.DIAMOND_CHEST.get()).build(null)
    );
    public static final RegistryObject<TileEntityType<H3KChestTile>> NETHERITE_CHEST = TILES.register(Constants.NETHERITE_CHEST,
